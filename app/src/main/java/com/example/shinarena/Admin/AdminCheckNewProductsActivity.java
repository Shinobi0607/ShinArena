package com.example.shinarena.Admin;
...
import com.example.shinarena.Interface.ItemClickListener;
import com.example.shinarena.R;
import com.example.shinarena.ViewHolder.ProductViewHolder;
...
public class AdminCheckNewProductsActivity extends AppCompatActivity {
    ...
    private void ChangeProductsState(String productsID) {
        unverifiedProductsRef.child(productsID).child("productState").setValue("Approved").addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
